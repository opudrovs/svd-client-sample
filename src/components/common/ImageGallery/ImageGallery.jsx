...
const ImageGallery = ({ imageData }) => {
  ...
  const isImageLoaded =
    !containsMultipleImages || (imageLoadedData && imageLoadedData[imageIndex]);
  const image = (
    <>
      {imageData && (
        <img
          ...
          className={classNames(styles.image, {
            [styles.imageHover]:
              isImageLoaded && containsMultipleImages && shouldShowOverlay,
          })}
          onLoad={
            containsMultipleImages ? () => onImageLoadHandler(imageIndex) : null
          }
        />
      )}
    </>
            ...
            <>
              {containsMultipleImages ? (
                ...
                <div className={styles.overlayIcons}>
                  <div className={classNames(styles.icon, styles.iconSmall)}>
                    <MagnifyPlusIcon />
                  </div>
                </div>
              )}
